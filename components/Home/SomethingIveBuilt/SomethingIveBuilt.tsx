        ...
        >
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              ...
              <div className="z-10 flex fle-row space-x-5 cursor-pointer">
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              ...
              <ul
               ...
               text-sm font-Text2 md:justify-start"
              >
                <span className="pr-4 z-10">Real-time Communication</span>
                <span className="pr-4 z-10">Client-Server Architecture</span>
