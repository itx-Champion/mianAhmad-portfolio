...
import TrouveTavoie from "./Descriptions/JudiciaryBahamas";
import FeverTokens from "./Descriptions/FeverTokens";
import IdealFresh from "./Descriptions/IdealFresh";
import Techxpert from "./Descriptions/AdvancedAgroManagement";
import Fantasia from "./Descriptions/Fantasia";
import Fantech from "./Descriptions/SuperBerry";
import Invextech from "./Descriptions/Invextech";
...
export default function WhereIHaveWorked() {
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("Invextech");
  return (
    <div
      data-aos="fade-up"
...
const CompaniesBar = (props: any) => {
  const [barPosition, setBarPosition] = React.useState<Number>(2); // Green bar position by the default it's -20px
  ...
  return (
    ...
    >
      {/* // ? left bar Holder */}
      <div
        className=" hidden md:block bg-gray-500 relative h-0.5 w-34 md:h-[280px] translate-y-1 md:w-0.5  
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        <div className="flex flex-row md:flex-col">
          <CompanyButton
            ...
            CompanyName="Invextech"
            BarPosition={2}
            BarAvobePosition={1}
            DescriptionJob="Invextech"
            CompanyNameBackgroundColorGreen={[
              true,
              false,
              false,
          ...
          <CompanyButton
            ...
            CompanyName="Judiciary Bahamas"
            BarPosition={46.5}
            BarAvobePosition={131.5}
            DescriptionJob="Judiciary Bahamas"
            CompanyNameBackgroundColorGreen={[
              false,
              false,
              true,
          ...
          <CompanyButton
            ...
            CompanyName="Fantech Labs"
            BarPosition={178}
            BarAvobePosition={516}
            DescriptionJob="Fantech Labs"
            CompanyNameBackgroundColorGreen={[
              false,
              false,
              false,
        ...
        <div className="block md:hidden h-0.5 rounded bg-gray-500">
          <motion.div
            ...
            className="w-[120px] h-0.5 rounded bg-AAsecondary"
          ></motion.div>
        </div>
      </div>
    </div>
